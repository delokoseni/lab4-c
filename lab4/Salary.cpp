...
//метод вывода
void Salary::output() {
    cout << "Коэффициент умножения оплаты сверхурочных часов: " << overtimecost;
    cout << "Коэффициент умножения оплаты часов отработанных в выходные: " << weekendcost;
    cout << "Коэффициент умножения оплаты за стаж: " << exppercent;
    cout << "Коэффициент умножения оплаты за наличие подчененных: " << subspercent;
    cout << "Учет стажа: " << expstatus;
    cout << "Учет наличия подчиненных: " << subsstatus;
}
